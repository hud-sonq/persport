...
const projectProps = {
  ...
  decoHrefs: ['https://github.com/hud-sonq/persport', 'https://github.com/hud-sonq/greenalpaca', 'https://accountonomics.com', 'https://devpost.com/software/dino-s-ocean-cleanup', 'https://github.com/hud-sonq/skybox']
}
